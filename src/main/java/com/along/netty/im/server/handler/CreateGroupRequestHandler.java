...
import com.along.netty.im.utils.IDUtils;
...
public class CreateGroupRequestHandler extends SimpleChannelInboundHandler<CreateGroupReqPacket> {
    ...
    @Override
    protected void channelRead0(ChannelHandlerContext ctx, CreateGroupReqPacket createGroupRequestPacket) {
